...
export const MODEL_RULESET_ENDPOINT = (id) => `serials-management/modelRulesets/${id}`;
export const MODEL_RULESET_EDIT_ENDPOINT = (id) => `serials-management/modelRulesets/${id}/replaceAndDelete`;
